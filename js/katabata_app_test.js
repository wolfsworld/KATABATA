...
var m_go=new Media(""+mediaURL+"sounds/go.mp3",success,error,onstatus);
var m_rest=new Media(""+mediaURL+"sounds/rest.mp3",success,error,onstatus);
var m_whip=new Media(""+mediaURL+"sounds/whip.mp3",success,error,onstatus);
var m_heartbeat=new Media(""+mediaURL+"sounds/heartbeat.mp3",success,error,onstatus);
var m_applause=new Media(""+mediaURL+"sounds/applause.mp3",success,error,ontatus);

/*sounds.push(new Media(""+mediaURL+"sounds/go.mp3"),success,error,status);
sounds.push(new Media(""+mediaURL+"sounds/rest.mp3"),success,error,status);
sounds.push(new Media(""+mediaURL+"sounds/whip.mp3"),success,error,status);
sounds.push(new Media(""+mediaURL+"sounds/heartbeat.mp3"),success,error,status);
sounds.push(new Media(""+mediaURL+"sounds/applause.mp3"),success,error,status);
*/	
exercises.push(new Media(""+mediaURL+"sounds/ex1.mp3"),success,error,onstatus);
exercises.push(new Media(""+mediaURL+"sounds/ex1.mp3"),success,error,onstatus);
exercises.push(new Media(""+mediaURL+"sounds/ex1.mp3"),success,error,onstatus);

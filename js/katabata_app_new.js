...
function go_ex(g){
	...
	$('#countdown').css({"opacity":"1","background-image":"url(img/red_btn_30.png)","color":"#F8E8FF","display":"block"});
...
function rest_ex(r){
	...
	$('#countdown').css({"opacity":"1","background-image":"url(img/btn_bg_lightgreen80.png)","color":"green","display":"block"});
	countdown1(v);
}
